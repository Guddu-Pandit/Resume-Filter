...
import { Trash2, FileText, Search, Eye, X, Upload, Loader2 } from "lucide-react";
                ...
                <div className="flex flex-col md:flex-row gap-4 items-center mb-6">
                    <div className="relative flex-1 w-full">
                        <input
                            ...
                            className="w-full pl-11 pr-4 py-3 bg-white border border-slate-200 rounded-xl focus:outline-none focus:border-[#00a86b] focus:ring-2 focus:ring-[#00a86b]/20 transition-all shadow-sm"
                            value={searchTerm}
